        ...
        >
          <PopoverTrigger as-child>
            ...
            >
              ...
              <span v-else class="text-[9px] text-muted-foreground leading-tight text-center">{{ sp.subtype }}</span>
            </button>
          </PopoverTrigger>
          <PopoverContent :collision-padding="12">
            <div class="flex flex-wrap gap-2" style="max-width: 380px">
              ...
              >
                ...
                />
                <div v-else class="w-full h-full bg-muted" />
                <span class="absolute bottom-0 left-0 right-0 text-[10px] leading-none text-foreground/80 text-center pb-[3px] truncate px-[3px]">
                  {{ opt.displayName }}
                </span>
              </button>
            </div>
